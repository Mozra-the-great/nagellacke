    ...
    <div className={styles.page}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.statsGrid}>
          <div className={styles.stat}><div className={styles.statNum}>{stats.polishes}</div><div className={styles.statLabel} title="Enthält auch Wunschliste, leere und aussortierte Lacke">Lacke gesamt</div></div>
